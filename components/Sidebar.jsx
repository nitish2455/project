...
const menuItems = [
  ...
  { id: 2, label: "Market Stories", icon: ArticleIcon, link: "/marketstory" },
  { id: 3, label: "Discussion Forums", icon: UsersIcon, link: "/discussion" },
...
const Sidebar = () => {
  ...
  const collapseIconClasses = classNames(
    "p-4 rounded bg-light-lighter absolute right-0 bg-white",
    {
    ...
    >
      <div className="flex flex-col">
        <div className="flex items-center justify-between relative">
          <div className="flex items-center pl-1 gap-4 text-white">
            <LogoIcon />
            <span
