...
<ol className="relative text-gray-500 border-s border-gray-200 dark:border-gray-700 dark:text-gray-400">                  
    <li className="mb-10 ms-6">            
        ...
        <h3 className="font-medium leading-tight pl-12">Configuration Github</h3>
        <p className="text-sm  pl-12">Step details here</p>
    </li>
    <li className="mb-10 ms-6">
        ...
        <h3 className="font-medium leading-tight  pl-12">Configuration deplotment</h3>
        <p className="text-sm  pl-12">Step details here</p>
    </li>
    <li className="mb-10 ms-6">
        <span className="absolute flex items-center justify-center w-8 h-8 bg-gray-100 rounded-full -start-4 ring-4 ring-white dark:ring-gray-900 dark:bg-gray-700">
        ...
        <h3 className="font-medium leading-tight  pl-12">Go Live</h3>
